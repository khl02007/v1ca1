...
import v1ca1.paper_figures.supplementary_figure_6 as supp_figure_4_module
from v1ca1.paper_figures.supplementary_figure_6 import (
...
def test_default_cli_matches_letter_width_with_one_inch_margins() -> None:
    ...
    assert DEFAULT_OUTPUT_NAME == "supplementary_figure_6"
...
def test_make_supplementary_figure_6_enforces_publication_font_hierarchy(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
    pandas = pytest.importorskip("pandas")
    ...
    output_path = tmp_path / "supplementary_figure_6.svg"
...
def test_make_supplementary_figure_6_plots_figure_2b_boxes_per_animal(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
    pandas = pytest.importorskip("pandas")
    ...
    saved_path = make_supplementary_figure_6(
        data_root=Path("/analysis"),
        output_path=output_path,
        datasets=datasets,
        region="v1",
