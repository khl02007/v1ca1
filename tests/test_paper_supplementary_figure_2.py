...
from v1ca1.paper_figures import supplementary_figure_2 as figure
...
def test_main_builds_named_output_and_forwards_options(
    ...
    def fake_make_supplementary_figure_2(**kwargs: object) -> Path:
        calls.update(kwargs)
    ...
    monkeypatch.setattr(
        ...
        fake_make_supplementary_figure_2,
    )
    figure.main(
        [
            "--data-root",
...
def test_make_supplementary_figure_2_draws_requested_panels_only(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
    ...
    def fail_if_omitted_panel_is_loaded(*args: object, **kwargs: object) -> None:
        del args, kwargs
        raise AssertionError("Supplementary Figure 2 loaded an omitted panel")
