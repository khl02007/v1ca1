"""Tests for the Spyglass Supplementary Figure 5 adapter."""
...
def test_render_is_atomic_and_writes_receipt(
    ...
    monkeypatch.setattr(figure.canonical, "make_supplementary_figure_5", render)

    assert figure.render_supplementary_figure_5(
        payload,
        output_path=output,
    ) == output
    ...
    with pytest.raises(FileExistsError):
        figure.render_supplementary_figure_5(payload, output_path=output)
