...
def compute_rate_function_headdir(
    epoch_idx: int,
    use_half: str,
    movement: str = "True",
    ...
    rate_function_save_dir = analysis_path / "rate_function_headdir"
    rate_function_save_dir.mkdir(parents=True, exist_ok=True)

    log_likelihood_save_dir = analysis_path / "log_likelihood_headdir"
    ...
    for region in regions:
        ...
        for trajectory_type in trajectory_types:
            ...
            classifier_save_path = classifier_save_dir / (
                f"classifier_{region}_{date}_{epoch}_headdir"
                f"_use_half_{use_half}"
                f"_movement_{movement}"
            ...
            for unit_index in unit_indices:
                ...
                for traj_start_time, traj_stop_time in trajectory_times[epoch][
                    ...
                    r = interpolate_nonmonotonic_x(head_direction_wrapped_interp, r)
