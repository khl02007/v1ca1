...
DEFAULT_PER_ANIMAL_RIPPLE_SELECTION = DEFAULT_FIGURE_4_GLM_RIPPLE_SELECTION
DEFAULT_RIPPLE_SELECTION_MODES = (DEFAULT_PER_ANIMAL_RIPPLE_SELECTION,)
DEFAULT_SOURCE_COMPARISON_RIPPLE_SELECTION = DEFAULT_FIGURE_4_GLM_RIPPLE_SELECTION
...
def parse_arguments(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Generate Supplementary Figure 4 ripple-GLM scatter panels."
    )
    parser.add_argument(
        "--data-root",
        type=Path,
