...
"""Generate Supplementary Figure 6 scalar controls and per-animal summaries."""
...
DEFAULT_OUTPUT_NAME = "supplementary_figure_6"
...
def get_figure_height_mm(n_animal_rows: int) -> float:
    """Return the Supplementary Figure 6 height for the requested row count."""
...
def make_supplementary_figure_6(
    *,
    data_root: Path,
    output_path: Path,
    datasets: Sequence[DatasetId],
    ...
    """Build and save Supplementary Figure 6."""
    ...
    if not datasets:
        ...
        plt.close(fig)
        print(f"Saved Supplementary Figure 6 to {output_path}")
        return output_path
...
def parse_arguments(argv: Sequence[str] | None = None) -> argparse.Namespace:
    """Parse command-line arguments for Supplementary Figure 6 generation."""
    parser = argparse.ArgumentParser(
        description=(
            "Generate Supplementary Figure 6 scalar controls and model summaries."
        )
    )
    parser.add_argument(
        "--data-root",
...
def main(argv: Sequence[str] | None = None) -> None:
    """Run Supplementary Figure 6 generation."""
