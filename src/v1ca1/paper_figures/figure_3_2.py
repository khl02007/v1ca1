"""Generate Figure 3_2 with a three-model architecture schematic."""
...
from v1ca1.paper_figures import figure_3 as _figure_3
...
DEFAULT_REGIONS = _figure_3.DEFAULT_REGIONS
...
TOP_ROW_HEIGHT_MM = _figure_3.TOP_ROW_HEIGHT_MM * (
    1.0 + PANEL_A_MODEL_ROW_PITCH
)
PANEL_B_ROW_HEIGHT_MM = 0.9 * _figure_3.BOTTOM_ROW_HEIGHT_MM
PANEL_C_ROW_HEIGHT_MM = 0.9 * _figure_3.BOTTOM_ROW_HEIGHT_MM
DEFAULT_FIGURE_HEIGHT_MM = (
    TOP_ROW_HEIGHT_MM + PANEL_B_ROW_HEIGHT_MM + PANEL_C_ROW_HEIGHT_MM
)
PANEL_TITLES = (
    "Three models that relate dark and light activity",
    _figure_3.PANEL_TITLES[1],
)
PANEL_LABEL_FONTSIZE = _figure_3.PANEL_LABEL_FONTSIZE
PANEL_A_B_LABEL_X = _figure_3.PANEL_A_B_LABEL_X
PANEL_B_LABEL_X = PANEL_A_B_LABEL_X
PANEL_C_LABEL_X = PANEL_A_B_LABEL_X
PANEL_ROW_LABEL_Y = _figure_2.PANEL_B_LABEL_Y
PANEL_BC_TITLE_PAD = _figure_3.PANEL_BC_TITLE_PAD
...
def build_output_path(
    ...
    """Return the Figure 3_2 output path for a supported format."""
    return _figure_3.build_output_path(output_dir, output_name, output_format)


def load_figure_3_2_panel_data(
    *,
    data_root: Path,
    ...
    """Load Figure 3 data and add matched full-additive predictions."""
    dataset_ids = tuple(datasets)
    panel_data = _figure_3.load_figure_3_panel_data(
        data_root=data_root,
...
def _configure_multiplicative_model_row(source_axis: Any) -> None:
    """Apply Figure 3_2 labels and operators to the multiplicative row."""
...
def make_figure_3_2(
    *,
    ...
    panel_data = load_figure_3_2_panel_data(
        data_root=data_root,
        datasets=datasets,
        regions=regions,
        dark_epoch=dark_epoch,
...
def parse_arguments(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Generate Figure 3_2.")
    parser.add_argument(
        "--data-root",
        type=Path,
