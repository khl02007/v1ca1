...
def fit_2d_decode_sleep_box(
    ...
    # define epoch name
    epoch = sleep_epoch_list[epoch_idx]

    print(
        f"Fitting 2d decoder on sleep box "
        f"{animal_name} {date} "
        f"epoch {epoch}, "
    ...
    for region in regions:
        ...
        classifier_save_path = classifier_save_dir / (
            f"classifier_{region}_{date}_{epoch}_2d_sleep_box"
