...
def load_classifier_dict(
    ...
    classifier_save_dir = analysis_path / "classifier_speed_trajectory"
...
def plot_speed_field_trajectory(
    speed_std=2.0,
):

    fig_save_path = analysis_path / "figs" / "speed_field_trajectory"
